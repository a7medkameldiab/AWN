...
namespace AWN.Migrations
{
    ...
    [Migration("20240528171500_CreateTables2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AccountRequestJoin", b =>
                {
                    b.Property<string>("accountsId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<int>("requestJoinsId")
                        .HasColumnType("int");

                    b.HasKey("accountsId", "requestJoinsId");

                    b.HasIndex("requestJoinsId");

                    b.ToTable("AccountRequestJoin", "AwnSc");
                });
            ...
            modelBuilder.Entity("AccountRequestJoin", b =>
                {
                    ...
                    b.HasOne("AWN.Models.RequestJoin", null)
                        .WithMany()
                        .HasForeignKey("requestJoinsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
